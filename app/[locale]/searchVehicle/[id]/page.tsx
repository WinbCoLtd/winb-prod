        ...
        <div className="mt-20 md:mt-0 md:ml-8 flex flex-col justify-start w-full md:w-[500px]">
          ...
          <div className="mt-[55px] flex justify-center w-full">
            <Link
              ...
              className="bg-winb-yellow text-[20px] lg:text-[18px] md:text-[20px] text-black font-medium px-4 py-4 sm:py-6 rounded-[25px] hover:bg-yellow-300 transition duration-300 w-full sm:w-auto text-center"
            >
