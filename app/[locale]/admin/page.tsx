...
//         <div className="w-[861px] bg-white shadow-md rounded-lg p-6 border border-winb-text-dark-blue">
//           <div className="grid grid-cols-2 gap-6">
//             <div>
//               <label className="text-[16px] text-black font-semibold">Manufacture</label>
//               <select className="w-full mt-5 border border-gray-300 rounded-md p-2 text-winb-ash font-semibold">
//                 <option value=""></option>
...
//             </div>
//             <div>
//               <label className="text-[16px] text-black font-semibold">Model</label>
//               <select className="w-full mt-5 border border-gray-300 rounded-md p-2 text-winb-ash font-semibold">
//                 <option value=""></option>
...
//             </div>
//             <div>
//               <label className="text-[16px] text-black font-semibold">Condition</label>
//               <select className="w-full mt-5 border border-gray-300 rounded-md p-2 text-winb-ash font-semibold">
//                 <option value=""></option>
...
//             </div>
//             <div>
//               <label className="text-[16px] text-black font-semibold">Drive Type</label>
//               <select className="w-full mt-5 border border-gray-300 rounded-md p-2 text-winb-ash font-semibold">
//                 <option value=""></option>
...
//             </div>
//             <div>
//               <label className="text-[16px] text-black font-semibold">Fuel Type</label>
//               <select className="w-full mt-5 border border-gray-300 rounded-md p-2 text-winb-ash font-semibold">
//                 <option value=""></option>
...
//             </div>
//             <div>
//               <label className="text-[16px] text-black font-semibold">Features</label>
//               <input
//                 type="text"
//                 placeholder="Enter features"
//                 className="w-full mt-5 border border-gray-300 rounded-md p-2 "
//               />
//             </div>
//             <div className="col-span-2">
//               <label className="text-[16px] text-black font-semibold">Description</label>
//               <textarea
//                 rows={4}
//                 className="w-full mt-5 border border-gray-300 rounded-md p-2"
...
//             <div>
//               <h3 className="text-[16px] text-black font-semibold mb-2">Exterior Colour</h3>
...
//             </div>
//             <div>
//               <h3 className="text-[16px] text-black font-semibold mb-2">Interior Colour</h3>
//               <div className="flex gap-2">
...
//             <button className="px-6 py-2 rounded-[15px] bg-blue-500 text-white font-semibold">Save as draft</button>
//             <button className="px-6 py-2  text-blue-500 font-bold hover:text-blue-950">Publish </button>
//           </div>
//         </div>

//         <div className="w-[294px] h-[314px] bg-white shadow-md rounded-lg p-6 border border-winb-text-dark-blue flex flex-col">
//             <div className="w-[250px] h-[218px] border-2 border-dashed border-gray-300 p-4 rounded-md text-[13px] text-center text-gray-500 font-semibold flex flex-col justify-center items-center">
//             <FontAwesomeIcon 
//                 icon={faImage} 
//                 className="mb-2 text-3xl text-gray-500" 
//             />
//             Drop your image or selected <span className="text-blue-600"> Click to browse</span>
//             </div>
