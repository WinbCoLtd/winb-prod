...
// function Deal() {
//   return (
//     <div className='relative w-full flex flex-col mx-auto bg-[#D9D9D9] mt-[66px]  pl-[77px]  sm:py-12'>

//     <div className="flex justify-centergrid-cols-1 sm:grid-cols-2 gap-6 ">
...
//             width={591}
//             height={557}
//             className="object-cover w-[591px] h-[557px] mt-[66px] mb-[66px]"
//         /> */}
        
//         <div className="flex flex-col justify-center ml-[41px] mr-[113px] mt-[2px]">
//         <h3 className="text-[40px] font-semibold text-black">
//             Get the Best Deal for Your Vehicle Today
//         </h3>
//         <p className="mt-3 sm:mt-4 text-[20px] font-medium text-[#333333]">
//             Join thousands of satisfied customers who found their perfect car with us. We offer exclusive benefits and 24/7 support.
//         </p>
        
//         <ul className="mt-3 sm:mt-4 text-[22px] font-medium text-[#333333] list-disc pl-10">
